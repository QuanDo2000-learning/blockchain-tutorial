...
class Blockchain(object):
    ...
    def proof_of_work(self, last_proof):
        ...
        Return:
            int: The answer to the algorithm
        """
        proof = 0
    ...
    def valid_proof(last_proof, proof):
        ...
        Returns:
            bool: True if correct and False otherwise
        """
    ...
    def resolve_conflicts(self):
        """The Consensus Algorithm, resolves conflicts by replacing our chain with the longest one in the network
...
def mine():
    # We run the Proof of Work algorithm the get the next proof...
    last_block = blockchain.last_block
    last_proof = last_block['proof']
    proof = blockchain.proof_of_work(last_proof)

    # Receive reward for finding the proof
    # The sender if '0' to signify that this node has mined a new coin
